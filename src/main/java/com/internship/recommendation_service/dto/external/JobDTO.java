...
public record JobDTO(
        ...
        @NotBlank(message = "Job title must not be blank") String title,
        @NotBlank(message = "Job description must not be blank") String description,
        ...
        @NotNull(message = "Job latitude must not be null") Double lat,
        @NotNull(message = "Job longitude must not be null") Double lon
) {
}
